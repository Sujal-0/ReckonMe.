  ...
  const handleSignup = async () => {
    if (validateSignup()) {
      ...
      try {
        ...
        const errorMsg = error.response?.data || "An error occurred during signup. Please try again.";
    ...
    <AnimatePresence>
      ...
      >
        ...
        <Highlighter action="highlight" color="#525252">
          <h1 className="text-3xl sm:text-4xl leading-tight font-semibold px-2 sm:px-6">Sign Up</h1>
        </Highlighter>
